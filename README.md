...
- **Área de estudo** — resumo do syllabus ordenado pelo peso de cada capítulo no exame, com leitura em voz alta (áudio pré-gerado com Google Cloud TTS, voz Chirp3-HD; controle de volume e velocidade) para ouvir o resumo enquanto faz outra atividade — sem nenhuma chamada de API em tempo real. Ver [`docs/SETUP.md`](docs/SETUP.md#leitura-em-voz-alta-áudio-estático-pré-gerado).
