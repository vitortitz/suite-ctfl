...
- **Área de estudo** — resumo do syllabus ordenado pelo peso de cada capítulo no exame, com leitura em voz alta (Google Cloud Text-to-Speech, com controle de volume, velocidade e voz) para ouvir o resumo enquanto faz outra atividade. Ver [`docs/SETUP.md`](docs/SETUP.md#leitura-em-voz-alta-google-cloud-text-to-speech).
